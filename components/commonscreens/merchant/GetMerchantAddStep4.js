...
function GetMerchantAddStep4(props) {
	...
	if (hasLocations) {
		button = <Button variant="contained" color="success" type="submit" className="col-md-12"> Save &amp; Continue </Button>
	} else {
		button = <Button variant="contained" color="success" type="submit" className="col-md-12" disabled={true}> Save &amp; Continue </Button>
	}
							...
							<div className="row">
								<div className="col-12" id="search">
									...
									<Paper>
										...
										<Tabs value={props.locationPanel} aria-label="simple tabs example" indicatorColor="primary" variant="scrollable" scrollButtons="auto"
											textColor="primary">
											<Tab label="Location Information" {...a11yProps(0)} disableRipple />
											<Tab label="PCI and Payments Compliance" {...a11yProps(1)} disableRipple />
														...
														<Row>
															...
															<Col md={3}>
																...
																<SelectField
																	...
																	onChange={props.handleItemChange}
																	validators={['required']} size="small"
														...
														<Row>
															<Col md={4}>
																...
																<TextBox
																	...
																	onChange={props.handleItemChange}
																	errorMessages={['Routing # is required', 'Routing # is invalid']}
															...
															<Col md={4}>
																...
																<TextBox
																	...
																	onChange={props.handleItemChange}
																	errorMessages={['Account # is required', 'Account # is invalid']}
																	validators={['required', 'matchRegexp:^[0-9]{9}$']}
																	variant={'outlined'} size="small"
																	inputProps={{
																		name: 'bankaccount',
										...
										<TabPanel value={props.locationPanel} index={1}>
											<ValidatorForm className="pt-3" onSubmit={() => props.updateActiveTab(2)}>
												<>
													<Row>
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Do you use a third party application that transmits or processes card holder data?</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Who enters credit card information into processing system?	</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															<Col md={4}>
																<label>If merchant is an e-commerce merchant, is an SSL certificate utilized?</label>
																<SelectField
													...
													<Row>
														...
														<Col md={1}>
															<Button variant="contained" color="primary" size="small" type="button"
																onClick={() => props.updateActiveTab(0)}> Back </Button>
														</Col>
														<Col md={1} className="text-right">
															<Button variant="contained" color="primary" size="small" type="submit"> Next </Button>
														</Col>
										...
										<TabPanel value={props.locationPanel} index={2}>
											<ValidatorForm className="pt-3" onSubmit={() => props.updateActiveTab(3)}>
												<>
													<Row>
														<Col>Equipment</Col>
														<br /><br />
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Do you use a POS provider to process cards?	</label>
																<SelectField
													...
													<Row>
														...
														<Col md={1}>
															<Button variant="contained" color="primary" size="small" type="button"
																onClick={() => props.updateActiveTab(1)}> Back </Button>
														</Col>
														<Col md={1} className="text-right">
															<Button variant="contained" color="primary" size="small" type="submit"> Next </Button>
														</Col>
										...
										<TabPanel value={props.locationPanel} index={3}>
											<ValidatorForm className="pt-3" onSubmit={() => props.updateActiveTab(4)}>
												<>
													<Row>
													...
													<div className="col-md-12 form-group">
														<Row>
															<Col md={4}>
																<label>Mail/Phone (Keyed without signature and imprint) %	</label>
																<TextBox
																	...
																	inputProps={{
																		name: 'mailorderpct',
																		id: 'mailorderpct',
																		placeholder: 'Mail/Phone (Keyed without signature and imprint) %	',
																		format: 'formatOption',
																		normalize: 'normalizeOption',
																		type: 'number',
																		min: 1,
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={8}>
																<label>Have merchant or owners/principals ever been terminated from accepting bankcards for the business?</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Does this location currently take Visa/MC/Discover?	</label>
																<SelectField
														...
														<Row>
															<Col md={6}>
																...
																<ValidatedDatePicker
																	...
																	onChange={(date) => props.handleDateChange('previousprocessorterminateddate', date.toLocaleDateString(), 'location')}
																/>
															</Col>
															<Col md={6}>
															...
															<Col md={4}>
																...
																<div>
																	<Select
																		...
																		name="mktingmethod"
																		multiple
																		value={props.location.mktingmethod ? props.location.mktingmethod : []}
																		onChange={(val) => { props.handleMultiSelectChange("mktingmethod", val.target.value) }}
																		input={<OutlinedInput />}
															...
															<Col md={4}>
																...
																<div>
																	<Select
																		...
																		name="merchanttype"
																		multiple
																		value={props.location.merchanttype ? props.location.merchanttype : []}
																		onChange={(val) => { props.handleMultiSelectChange("merchanttype", val.target.value) }}
																		input={<OutlinedInput />}
																		renderValue={(selected) => selected.join(', ')}
																		MenuProps={MenuProps}
																	>
													...
													<div className="col-md-12 form-group">
														<Row>
															<Col md={6}>
																<label>If Yes, please check all months in which your merchant account will be active</label>
																<div>
																	<Select
																		fullWidth
																		size="small"
																		...
																		name="seasonalmonths"
																		multiple
																		value={props.location.seasonalmonths ? props.location.seasonalmonths : []}
																		onChange={(val) => { props.handleMultiSelectChange("seasonalmonths", val.target.value) }}
																		input={<OutlinedInput />}
																		renderValue={(selected) => selected.join(', ')}
																		MenuProps={MenuProps}
																	>
													...
													<div className="col-md-12 form-group">
														<Row>
															<Col md={12}>
																<label>What descriptor would you like to appear on customers credit card statement (max 24 characters)	</label>
																<TextBox
																	...
																	inputProps={{
																		...
																		placeholder: 'What descriptor would you like to appear on customers credit card',
																		type: 'text',
																		classselector: "h-auto"
																	}}
																/>
													...
													<Row>
														...
														<Col md={1}>
															<Button variant="contained" color="primary" size="small" type="button"
																onClick={() => props.updateActiveTab(2)}> Back </Button>
														</Col>
														<Col md={1} className="text-right">
															<Button variant="contained" color="primary" size="small" type="submit"> Next </Button>
														</Col>
										...
										<TabPanel value={props.locationPanel} index={4}>
											<ValidatorForm className="pt-3" onSubmit={() => props.updateActiveTab(5)}>
												<>
													<Row>
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>
																	If you did not check all cards above, <br>
																	</br>
																...
																<div>
																	<Select
																		...
																		name="selectedcards"
																		multiple
																		value={props.location.selectedcards ? props.location.selectedcards : []}
																		onChange={(val) => { props.handleMultiSelectChange("selectedcards", val.target.value) }}
																		input={<OutlinedInput />}
																		renderValue={(selected) => selected.join(', ')}
																		MenuProps={MenuProps}
																	>
															...
															<Col md={4}>
																<label>Does any of your billing or marketing strategy involve negative response or automatic billing?</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Do you offer product/Service Warranty or Guarantees?</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															<Col md={4}>
																<label>Please list all third party payment processors merchant does business with	</label>
																<TextBox
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Are all of your products/services delivered immediately?	 </label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={4}>
																<label>Do you have a refund policy for Visa/MasterCard/Discover?	</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															<Col md={4}>
																<label>If Visa/MasterCard/Discover credit, within how many days do you submit credit transactions?	</label>
																<SelectField
															...
															<Col md={4}>
																<label>Does your business charge recurring billings to customers?</label>
																<SelectField
													...
													<div className="col-md-12 form-group">
														<Row>
															...
															<Col md={3}>
																<label>If yes, how many days before final delivery?		</label>
																<TextBox
															...
															<Col md={3}>
																<label>Visa/MasterCard/Discover card sales are charged to the card on</label>
																<SelectField
													...
													<Row>
														<label>How long after payment is product delivered or service fulfilled?</label>
													</Row>
													<div className="col-md-12 form-group">
														<Row>
															<Col md={6}>
													...
													<Row>
														...
														<Col md={1}>
															<Button variant="contained" color="primary" size="small" type="button"
																onClick={() => props.updateActiveTab(3)}> Back </Button>
														</Col>
														<Col md={1} className="text-right">
															<Button variant="contained" color="primary" size="small" type="submit"> Next </Button>
														</Col>
										...
										<TabPanel value={props.locationPanel} index={5}>
											<ValidatorForm className="pt-3" onSubmit={() => { props.addMerchantStep4(props.locations, props.merchantId) }}>
												<>
													<Row>
													...
													<div className='col-md-12 form-group'>
														<Row>
															...
															<Col md={4}>
																<label>&nbsp;</label>
																<Button variant="contained" color="success" onClick={() => { props.uploadDocument(props.formFile, props.document) }} className="col-md-12"> Upload </Button>
															</Col>
														</Row>
													</div>
													<div className='col-md-12 form-group'>
												...
												<Row>
													<Col md="3">
														<Button variant="contained" color="primary" type="button" className="col-md-12"
															onClick={() => props.updateActiveTab(4)}> Back to last tab </Button>
													</Col>
													<Col md="3">
