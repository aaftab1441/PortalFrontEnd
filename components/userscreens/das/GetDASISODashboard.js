...
export class GetDASISODashboard extends Component {
  constructor(props){
    super(props)
    this.state = {
  ...
  render () {
      ...
      this.RevenueShare = [
        { data: this.props.dashboardData.TotalAssoc, id: 'Total Assoc.', color: '#ffc100'},
        { data: this.props.dashboardData.TotalSchedAFees, id: 'Total Sched. A', color: '#5E5D5D'},
        { data: this.props.dashboardData.RevenueShare, id: 'Revenue Share', color: '#5D5D5E'},
        { data: this.props.dashboardData.NetIncome, id: 'Net Income', color: '#DC10D2'},
        { data: this.props.dashboardData.DasRevenueShare, id: 'Das Revenue Share', color: '#10DC1F'}
      ];
      ...
      this.YTDSalesReportData = [
        ...
        this.MonthChargeBacksReportData = [
          {
            data: this.props.dashboardData.CurrentMonthChargeBacks,
              id: 'Current 6 Months1',
              color: '#ffc100',
          },
          {
            data: this.props.dashboardData.PreviousMonthChargeBacks,
            id: 'Previous 6 Months',
            color: '#f5a623',
      ...
      <div>   
        <div className="row">
          <div className="col-12 col-xl-3 mb-4 mb-xl-0 grid-margin">
            <h4 className="font-weight-bold">{this.props.iso.ISO_NAME} Dashboard</h4>
          </div>
          ...
          <div className="col-md-3 grid-margin stretch-card">
            <div className="card">
               <a href="javascript:void()">
                <div className="card-body" onClick={() => this.props.router.push(AppConstants.DAS_ISO_MERCHANT_LIST_COUNT_PATH + "?#iso/inactive")}>
                  ...
                  <p className={"mb-0 mt-2 " + StringUtils.percentChangeIsUp(this.props.dashboardData.TotalMerchants, this.props.dashboardData.PreviousTotalMerchants)? "text-success": "text-danger"}>
                  </p>
                </div>
                </a>
            </div>
            ...
            <div className="card">
               <a href="javascript:void()">
                <div className="card-body" onClick={() => this.props.router.push(AppConstants.DAS_ISO_MERCHANT_LIST_COUNT_PATH + "?#iso/inactive")}>
                  ...
                  <p className={"mb-0 mt-2 " + StringUtils.percentChangeIsUp(this.props.dashboardData.ActiveMerchants, this.props.dashboardData.PreviousActiveMerchants)? "text-success": "text-danger"}>
                   </p>
                </div>
              </a>
            </div>
            ...
            <div className="card">
               <a href="javascript:void()">
                <div className="card-body" onClick={() => this.props.router.push(AppConstants.DAS_ISO_MERCHANT_LIST_COUNT_PATH + "?#iso/inactive")}>
                  ...
                  <p className={"mb-0 mt-2 " + StringUtils.percentChangeIsUp(this.props.dashboardData.ClosedMerchants, this.props.dashboardData.PreviousClosedMerchants)? "text-success": "text-danger"}>
                   </p>
                </div>
                </a>
            </div>
            ...
            <div className="card">
               <a href="javascript:void()">
                <div className="card-body" onClick={() => this.props.router.push(AppConstants.DAS_ISO_MERCHANT_LIST_COUNT_PATH + "?#iso/inactive")}>
                  ...
                  <p className={"mb-0 mt-2 " + StringUtils.percentChangeIsUp(this.props.dashboardData.InActiveMerchants, this.props.dashboardData.PreviousInActiveMerchants)? "text-success": "text-danger"}>
                  </p>
                </div>
                </a>
            </div>
              ...
              <div className="card-body">
                <Row>
                    ...
                    <Col md={3} className="text-right p-0">
                      <Button variant="contained" color="primary" type="button" onClick={() => this.props.router.push(AppConstants.ISO_MERCHANT_DASHBOARD_PATH)} className="ml-3"> Merchant List</Button>
                    </Col>
                  </Row>
              ...
              <div className="card-body">
                <Row>
                    <Col>
                        ...
                        <span className="text-muted small-font">&nbsp;</span><br />
                    </Col>
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <RiskSection currentObject={this.props.iso} currentObjectType={'ISO'} {...this.props}/>
              </div>
...
GetDASISODashboard.propTypes = {
  displayWarning: PropTypes.func,
};
 

export default GetDASISODashboard;
