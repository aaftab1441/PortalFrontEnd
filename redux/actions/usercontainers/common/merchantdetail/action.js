...
export function exportChargeBacks(params, user, merchant){ return {type: Constants.EXPORT_CHARGE_BACK_ACTION, params, user, merchant} }
export function receivedExportChargeBacksAction(data){ return {type: Constants.RECEIVED_CHARGE_BACK_EXPORT_ACTION, data}}
export function receivedExportChargeBacksError(err, data){ return {type: Constants.RECEIVED_CHARGE_BACK_EXPORT_ERROR, err, data}}

export function viewStatement(params, user, merchant){ return {type: Constants.GET_STATEMENT_ACTION, params, user, merchant} }
export function receivedExportStatementAction(data){ return {type: Constants.RECEIVED_STATEMENT_ACTION, data}}
export function receivedExportStatementError(err, data){ return {type: Constants.RECEIVED_STATEMENT_ERROR, err, data}}
