...
const initialState = {
  ...
  currentItem: {Detail: {}, Users: [], SalesAgents:[]}, 
  changeState: 0,
  panel: 0,
  params: {name: '', streetAddress: '', city: '', state: ''},
};

const salesOfficeManagementReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case Constants.EDIT_ITEM:
      let editItem = {Detail: {}, Users: [], SalesAgents:[]};
    ...
    case Constants.ADD_ITEM:
      let newItem = {Detail: {}, Users: [], SalesAgents:[]};
...
export default  salesOfficeManagementReducer;