...
import GetListSalesAgents from "/components/commonscreens/organization-management/sales-agent/GetListSalesAgents";
...
class ListSalesAgents extends React.PureComponent {
	constructor(props){
		super(props);
	}
	...
	render(){
	  console.log("ListSalesAgents Index", this.props);
...
const  mapStateToProps = (state) =>{ 
	return { 
		...
		itemList: state.salesAgentOrganizationManagement.list,
		params: state.salesAgentOrganizationManagement.params,
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListSalesAgents));
