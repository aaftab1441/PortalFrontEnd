...
import GetListSubISOs from "/components/commonscreens/organization-management/subiso/GetListSubISOs";
...
class ListSubIso extends React.PureComponent {
	constructor(props){
		super(props);
	}
	...
	render(){
	  console.log("ListSubIso Index", this.props);
...
const  mapStateToProps = (state) =>{ 
	return { 
		...
		itemList: state.subIsoOrganizationManagement.list,
		params: state.subIsoOrganizationManagement.params,
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    viewItem: (iso, user) => dispatch(Actions.getItem(iso, user)),
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListSubIso));
