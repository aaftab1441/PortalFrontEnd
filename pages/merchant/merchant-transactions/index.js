...
import GetMerchantTransactions from "../../../components/commonscreens/GetMerchantTransactions";
...
class MerchantTransactions extends React.PureComponent {
	constructor(props){
		super(props);
	}
	  ...
	  if(this.props.task == Constants.MOVE_TO_URL_ACTION){
	    ...
	    return (
			<div className="container-scroller">
			  <GetHeader title={'Eagle Processing Merchant Transactions'} description={'Eagle Processing Merchant Merchant Transactions'} {...this.props}/>
		      <Navbar {...this.props} />
			  <div className="container-fluid page-body-wrapper">
			  <Sidebar  {...this.props} />
			  <div className="main-panel">
				<div className="content-wrapper">
					<GetMerchantTransactions {...this.props} />
...
MerchantTransactions.propTypes = {
  ...
  genericMerchantTransactionsData: PropTypes.object,
  genericMerchantTransactionsParams: PropTypes.object,
...
const  mapStateToProps = (state) =>{ 
	return { 
		task: state.genericMerchantTransactions.task,
		loading: state.genericMerchantTransactions.loading,
		messages: state.central.messages,
		moveToUrl: state.genericMerchantTransactions.moveToUrl,
		lists: state.central.lists,
		user: state.central.user,
		genericMerchantTransactionsData: state.central.genericMerchantTransactionsData,
		searchType: state.genericMerchantTransactions.searchType,  
		data: state.genericMerchantTransactions.data,
		allData: state.genericMerchantTransactions.allData,
		changeState: state.genericMerchantTransactions.changeState,
		merchantSearchParams: state.genericMerchantTransactions.merchantSearch,
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(MerchantTransactions));
